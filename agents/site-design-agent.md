...
4.  **Turn 4: Validation & Linting:**
    *   Execute the code linters provided by the active Skills, as defined inside each Skill's respective verification manuals. Correct any identified linting or schema errors on-disk before yielding control back to the Conductor.
