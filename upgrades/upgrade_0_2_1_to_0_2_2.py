...
def run_upgrade(extension_dir, project_dir):
    """
    Upgrades a project from LDA 0.2.1 to 0.2.2.
    Copies our newly updated, optimized, and secure scripts:
      * deploy-fragments.py
      * deploy-stylebook.py
      * deploy-client-extensions.py
    directly into the project's ./scripts/ folder.
    """
    print("Executing upgrade step: 0.2.1 -> 0.2.2...")
    
    # List of all newly updated/polished scripts to copy/upgrade
    scripts_to_copy = [
        "deploy-fragments.py",
        "deploy-stylebook.py",
        "deploy-client-extensions.py"
    ...
    print("Successfully completed upgrade step: 0.2.1 -> 0.2.2!")
    return True
